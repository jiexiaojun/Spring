...
CREATE TABLE `sys_log` (
  ...
  `username` varchar(50) CHARACTER SET utf8 DEFAULT NULL COMMENT '操作用户名',
  `operation` varchar(50) CHARACTER SET utf8 DEFAULT NULL COMMENT '用户操作',
  `method` varchar(200) CHARACTER SET utf8 DEFAULT NULL COMMENT '调用方法',
  `params` varchar(5000) CHARACTER SET utf8 DEFAULT NULL,
  `ip` varchar(20) CHARACTER SET utf8 DEFAULT NULL COMMENT '操作ip地址',
