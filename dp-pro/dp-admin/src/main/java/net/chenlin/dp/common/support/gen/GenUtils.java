...
public class GenUtils {
	...
	public static List<String> getTemplates() {
		...
		templates.add("generator/template/Mapper.java.vm");
		...
		templates.add("generator/template/add.html.vm");
		templates.add("generator/template/add.js.vm");
		templates.add("generator/template/edit.html.vm");
		templates.add("generator/template/edit.js.vm");
